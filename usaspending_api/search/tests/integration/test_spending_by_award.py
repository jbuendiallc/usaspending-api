...
def test_naics_code_query_sting_logic(client, monkeypatch, spending_by_award_test_data, elasticsearch_award_index):
    ...
    # TODO: DO EXTRA WORK HERE TO BUILD-UPON THE spending_by_award_test_data
    # TODO: - Add extra award records to have enough awards for NAICS tests
        ...
        data=json.dumps(
            {
                "filters": {
                    ...
                    "naics_codes": {"require": ["1122"], "exclude": ["112244"]},  # TODO: TRY DIFFERENT COMBOS
